	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`bowenleixing`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																																if(this.ruleForm.id){
					await this.$api.update(`bowenleixing`, this.ruleForm);
				}else{
					await this.$api.add(`bowenleixing`, this.ruleForm);
				}
